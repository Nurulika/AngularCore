...
#[derive(Debug)]
pub struct AngularCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AngularCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AngularCore processing");
    
    let mut processor = AngularCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AngularCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AngularCoreProcessor::new(false);
